...
//  SwiftTraining
//
//  Created by yuki noda on 2024/11/26.
//
...
final class Sample2ViewController: UIViewController {
    ...
    private static let text2 = "吾輩は猫である。名前はまだ無い。どこで生れたかとんと見当がつかぬ。"
    
    override func viewDidLoad() {
        super.viewDidLoad()
        textLabel.text = Bool.random() ? Self.text1 : Self.text2
    }
}
